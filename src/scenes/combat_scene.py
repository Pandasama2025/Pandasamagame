...
class CombatScene(BaseScene):
    ...
    def draw(self, screen):
        ...
        """
        # 绘制背景
        screen.fill((60, 60, 60))  # 灰色背景
        
        # 绘制角色（临时使用矩形）
        pygame.draw.rect(screen, (100, 100, 200), pygame.Rect(100, 100, 100, 150))  # 玩家
        pygame.draw.rect(screen, (200, 100, 100), pygame.Rect(600, 100, 100, 150))  # 敌人
        
        if self.ally:
            pygame.draw.rect(screen, (100, 200, 100), pygame.Rect(250, 150, 80, 120))  # 盟友
